...
BEGIN
  ...
  VALUES ('synthetic-user-1')
  RETURNING username INTO v_user_id;

  INSERT INTO edge_devices (device_id, device_type)
  VALUES ('synthetic-device-1', 'jetson-nano')
  RETURNING device_id INTO v_edge_device_id;
